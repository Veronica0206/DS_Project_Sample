...
### Analyze the impact of the referral program

#### Add a flag in the referral dataset to indicate if the transaction happened after the test date (i.e., 2015-10-31 in this case)

    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##  0.0000  0.0000  1.0000  0.5603  1.0000  1.0000
